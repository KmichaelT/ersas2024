...
function Block({
  ...
  return (
    <motion.path
      ...
      d="M76.35,19.19L57.45.28c-.21-.21-.46-.29-.68-.28v.02c-.08-.02-.15-.02-.23-.01H.93c-.51,0-.93.42-.93.93v56s.08.48.28.68l18.91,18.91c.21.21.46.29.68.28v-.02c.08.02.15.02.23.01h55.6c.51,0,.93-.42.93-.93V19.87s-.08-.48-.28-.68Z"
      {...props}
    />
  )
}
