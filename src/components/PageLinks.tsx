...
function PageLink({ page }: { page: Page }) {
  return (
    <article key={page.href}>
      ...
      >
        <h3 className="mt-6 text-base font-semibold text-cyan-950">
          {page.title}
        </h3>
        <time
          dateTime={page.date}
        ...
        <Link
          href={page.href}
          className="mt-6 flex gap-x-3 text-base font-semibold text-cyan-950 transition hover:text-neutral-700"
  ...
  return (
    <div className={clsx('relative pt-24 sm:pt-32 lg:pt-40', className)}>
      {/* <div className="absolute inset-x-0 top-0 -z-10 h-[884px] overflow-hidden rounded-t-4xl bg-gradient-to-b from-neutral-50">
        <GridPattern
          className="absolute inset-0 h-full w-full fill-neutral-100 stroke-cyan-950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
          yOffset={-270}
        />
      </div> */}
