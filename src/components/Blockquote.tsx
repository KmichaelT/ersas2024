...
function BlockquoteWithImage({
  ...
  return (
    ...
    >
      ...
      <div className="col-start-1 row-start-2 overflow-hidden rounded-xl bg-transparent sm:col-span-5 sm:row-span-full sm:rounded-3xl">
      ...
      <figcaption className="text-sm text-cyan-950 sm:col-span-7 sm:row-start-3 sm:text-base">
  ...
  return (
    <Border position="left" className={clsx('pl-8', className)}>
      <figure className="text-md">
        ...
        <figcaption className="mt-6 font-semibold text-cyan-950">
